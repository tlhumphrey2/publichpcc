...
new_instance_ip=10.60.0.158
new_instance_id=i-22c0f2b2
new_instance_asgnames=asgnames.txt-with-replacement-slave2
new_public_ips=public_ips.txt-with-replacement-slave2
new_environment_xml=environment.xml-with-replacement-slave2
